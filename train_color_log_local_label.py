...
if __name__ == '__main__':
    ...
    lr         = 3e-4
    epochs     = 550
    save_path  = f"./Model/color_log_local_{args.label}" 
    logger = MyLogger(f"color_log_local_{args.label}")
    ...
    plot_train_val(train_losses, val_losses, f"color_log_local_{args.label}.png")
